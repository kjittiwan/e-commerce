  ...
  return (
    <div className="pt-36 bg-[#FAF4EE]">
      ...
      <div className="flex flex-col items-center md:flex-row  md:px-16 flex-1 mb-16 md:items-start justify-between mx-10 md:mx-32">
        <div className="md:hidden text-[35px] font-semibold text-center">You are what you wear</div>
      ...
      <div className='flex flex-col md:flex-row mx-10 md:mx-32 gap-y-16 md:gap-x-20 mb-16'>
      ...
      <div className='bg-[#ff7700] bg-opacity-5 flex px-10 md:px-32 pt-16 pb-24'>
