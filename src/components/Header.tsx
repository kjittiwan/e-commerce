...
function Header() {
  ...
  return (
    <header className={` ${isSticky ? 'fixed mt-0 drop-shadow-lg' : 'absolute mt-10'} bg-white  w-full z-10 transition-all duration-500 flex justify-between items-center px-6    py-5 `}>
